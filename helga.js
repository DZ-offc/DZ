...
try {
		...
		const katalog = (teks) => {
             res = helga.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© RaaDz_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             helga.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = helga.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6282138919347-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IlpQRKWDZed0GgVHmYJUbl', "groupName": `${NamaBot}`, "footerText": "*_© RaaDz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
await helga.setStatus(`⛾ Dz-BOTZ || ⏳ Runtime: ${uptime} || 🎧 Uptime: ${kyun(os.uptime())}`).catch((_) => _);
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© RaaDz_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
reply(String(e))
	...
	numd = await fetchJson(``, {method: 'get'})			
	simi = await fetchJson(``)
                     sami = simi.success
                        helga.sendMessage(from, `_${sami}_`, text, {thumbnail: ofrply, sendEphemeral: true, quoted:mek, contextInfo : {forwardingScore: 508, isForwarded: true}})
                      }
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© RaaDz_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
*🍃ヅ* ${prefix}artimimpi 
*🍃ヅ* ${prefix}bilangangka 
*🍃ヅ* ${prefix}kalkulator 
*🍃ヅ* ${prefix}fancytext 
*🍃ヅ* ${prefix}githubstalk 
*🍃ヅ* ${prefix}translate 
*🍃ヅ* ${prefix}ss 
*🍃ヅ* ${prefix}playstore 
...
*🍃ヅ* ${prefix}quote
*🍃ヅ* ${prefix}wetglass
*🍃ヅ* ${prefix}multicolor3d
*🍃ヅ* ${prefix}watercolor
*🍃ヅ* ${prefix}luxurygold
*🍃ヅ* ${prefix}galaxywallpaper
*🍃ヅ* ${prefix}lighttext
*🍃ヅ* ${prefix}beautifulflower
*🍃ヅ* ${prefix}puppycute
*🍃ヅ* ${prefix}royaltext
*🍃ヅ* ${prefix}heartshaped
*🍃ヅ* ${prefix}birthdaycake
*🍃ヅ* ${prefix}galaxystyle
*🍃ヅ* ${prefix}hologram3d
*🍃ヅ* ${prefix}glossychrome
*🍃ヅ* ${prefix}greenbush
*🍃ヅ* ${prefix}metallogo
*🍃ヅ* ${prefix}noeltext
*🍃ヅ* ${prefix}glittergold
*🍃ヅ* ${prefix}textcake
*🍃ヅ* ${prefix}starsnight
*🍃ヅ* ${prefix}wooden3d
*🍃ヅ* ${prefix}textbyname
*🍃ヅ* ${prefix}writegalacy
*🍃ヅ* ${prefix}galaxybat
*🍃ヅ* ${prefix}snow3d
*🍃ヅ* ${prefix}birthdayday
*🍃ヅ* ${prefix}goldplaybutton
*🍃ヅ* ${prefix}silverplaybutton
*🍃ヅ* ${prefix}freefire
*🍃ヅ* ${prefix}shadow
*🍃ヅ* ${prefix}cup
*🍃ヅ* ${prefix}cup1
...
*🍃ヅ* ${prefix}smoke
*🍃ヅ* ${prefix}burnpaper
*🍃ヅ* ${prefix}lovemessage
*🍃ヅ* ${prefix}undergrass
*🍃ヅ* ${prefix}love
*🍃ヅ* ${prefix}coffe
*🍃ヅ* ${prefix}woodheart
*🍃ヅ* ${prefix}woodenboard
*🍃ヅ* ${prefix}summer3d
*🍃ヅ* ${prefix}wolfmetal
*🍃ヅ* ${prefix}nature3d
*🍃ヅ* ${prefix}underwater
*🍃ヅ* ${prefix}golderrose
*🍃ヅ* ${prefix}summernature
*🍃ヅ* ${prefix}letterleaves
*🍃ヅ* ${prefix}glowingneon
*🍃ヅ* ${prefix}fallleaves
*🍃ヅ* ${prefix}flamming
...
*🍃ヅ* ${prefix}space
*🍃ヅ* ${prefix}ninjalogo
*🍃ヅ* ${prefix}marvelstudio
*🍃ヅ* ${prefix}lionlogo
*🍃ヅ* ${prefix}wolflogo
*🍃ヅ* ${prefix}steel3d
*🍃ヅ* ${prefix}wallgravity
*🍃ヅ* ${prefix}ppcp
*🍃ヅ* ${prefix}anime
*🍃ヅ* ${prefix}blackpink
*🍃ヅ* ${prefix}neon
*🍃ヅ* ${prefix}greenneon
*🍃ヅ* ${prefix}advanceglow
*🍃ヅ* ${prefix}futureneon
*🍃ヅ* ${prefix}sandwriting
*🍃ヅ* ${prefix}sandsummer
*🍃ヅ* ${prefix}sandengraved
*🍃ヅ* ${prefix}metaldark
*🍃ヅ* ${prefix}neonlight
*🍃ヅ* ${prefix}holographic
*🍃ヅ* ${prefix}text1917
*🍃ヅ* ${prefix}minion
*🍃ヅ* ${prefix}deluxesilver
*🍃ヅ* ${prefix}newyearcard
*🍃ヅ* ${prefix}bloodfrosted
*🍃ヅ* ${prefix}halloween
*🍃ヅ* ${prefix}jokerlogo
*🍃ヅ* ${prefix}fireworksparkle
*🍃ヅ* ${prefix}natureleaves
*🍃ヅ* ${prefix}bokeh
*🍃ヅ* ${prefix}toxic
*🍃ヅ* ${prefix}strawberry
*🍃ヅ* ${prefix}box3d
...
*🍃ヅ* ${prefix}cloud
*🍃ヅ* ${prefix}summersand
*🍃ヅ* ${prefix}horrorblood
*🍃ヅ* ${prefix}thunder
*🍃ヅ* ${prefix}tiktok
*🍃ヅ* ${prefix}arcade8bit
*🍃ヅ* ${prefix}battlefield4
*🍃ヅ* ${prefix}pubg
...
*🍃ヅ* ${prefix}bocil
*🍃ヅ* ${prefix}ghea
*🍃ヅ* ${prefix}cecanrandom
*🍃ヅ* ${prefix}cecanvietnam
*🍃ヅ* ${prefix}bokep

     『 _STORAGE_ 』
     
*🍃ヅ* ${prefix}listimage
*🍃ヅ* ${prefix}liststicker
*🍃ヅ* ${prefix}listvn
*🍃ヅ* ${prefix}addsticker
*🍃ヅ* ${prefix}delsticker 
*🍃ヅ* ${prefix}addvn
...
Note : Jika Buton Tidak Muncul Ketik .allmenu`
menu =`𝑯𝒆𝒍𝒈𝒂𝒂 𝒁𝒆𝒙`
gbutsan = [
{buttonId:`allmenu`,buttonText:{displayText:'📑𝘼𝙇𝙇 𝙈𝙀𝙉𝙐'},type:1},
{buttonId:`store`,buttonText:{displayText:'𝙎𝙀𝙒𝘼 𝘽𝙊𝙏💤'},type:1},
{buttonId:`rules`,buttonText:{displayText:'📖𝙍𝙀𝙂𝙐𝙇𝘼𝙏𝙄𝙊𝙉'},type:1}
]
...
│
└───『 \`\`\`${NamaBot}\`\`\`』`
sendButLocation(from, `${menu}`, "*_© RaaDz_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
/*case 'sewa1':
               list = []
...
DZ BOT merupakan project bot WhatsApp yang menggunakan Rdp, dijalankan menggunakan engine nodejs v14.0.0
...
🌳豈 _Creator : @${dtod.split('@')[0]}_
🌳豈 _Battery : ${baterai.battery}_
🌳豈 _Mode : ${publik ? 'Public' : 'Self'}_
🌳豈 _Total Hit : ${cmhit.length}_
🌳豈 _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
🌳豈 _Nama Bot : ${NamaBot}_
🌳豈 _Nama Owner : ${NamaOwner}_
🌳豈 _Nomor Owner : @${otod.split('@')[0]}_
🌳豈 _Auto Composing : ${settings.autocomposing}_
🌳豈 _Auto Recording : ${settings.autorecording}_


       『 User Info 』
       
🌳豈 _Status : ${isOwner ? 'Owner' : 'User'}_
🌳豈 _Nama : ${pushname}_
🌳豈 _Bio : ${stst}_
🌳豈 _Nomor : @${stod.split('@')[0]}_
...
if(menuall == false){
   //Masih langka
function _0x21f8(){var _0x5b970c=['5573144JYwLrC','528103swWGih','image/jpeg','HZ7GZtD+MZleBjG1flbeTuZkDThPV6frfERXi4zTBvs=','readFileSync','69880vdqygB','431675fOwedq','3264wpwOzQ','3ucdrq0UyCuNG5YcUD9aKX4qkuvcip+OonjhACusy5Q=','988644bxSaXV','19894ILewVQ','2QmpxNq','66214','9999999','1341KlrShJ','2506689kwMmco','./helga.jpg'];_0x21f8=function(){return _0x5b970c;};return _0x21f8();}function _0x4cac(_0x23a824,_0x283a6f){var _0x21f8ef=_0x21f8();return _0x4cac=function(_0x4cacde,_0x3311de){_0x4cacde=_0x4cacde-0xc7;var _0x13ea77=_0x21f8ef[_0x4cacde];return _0x13ea77;},_0x4cac(_0x23a824,_0x283a6f);}var _0xcdc6be=_0x4cac;(function(_0x130db2,_0x4b9859){var _0x3cd68e=_0x4cac,_0x5ee5d3=_0x130db2();while(!![]){try{var _0x2ac92a=-parseInt(_0x3cd68e(0xce))/0x1*(-parseInt(_0x3cd68e(0xc7))/0x2)+parseInt(_0x3cd68e(0xcb))/0x3+-parseInt(_0x3cd68e(0xd6))/0x4+-parseInt(_0x3cd68e(0xd3))/0x5+parseInt(_0x3cd68e(0xd4))/0x6*(parseInt(_0x3cd68e(0xd7))/0x7)+-parseInt(_0x3cd68e(0xcd))/0x8+parseInt(_0x3cd68e(0xca))/0x9*(-parseInt(_0x3cd68e(0xd2))/0xa);if(_0x2ac92a===_0x4b9859)break;else _0x5ee5d3['push'](_0x5ee5d3['shift']());}catch(_0x5691cb){_0x5ee5d3['push'](_0x5ee5d3['shift']());}}}(_0x21f8,0xccadb),anu=helga['prepareMessageFromContent'](from,{'productMessage':{'product':{'productImage':{'url':'https://mmg.whatsapp.net/d/f/Aj5vJ5V6aD4eIRoj-9Q26GBNXq_AeVscAB9ENRvLEPmO.enc','mimetype':_0xcdc6be(0xcf),'fileSha256':_0xcdc6be(0xd0),'fileLength':_0xcdc6be(0xc8),'height':0x2d0,'width':0x2d0,'mediaKey':_0xcdc6be(0xd5),'fileEncSha256':'ifE4O/SNQnPWVe8ya6QZlshnaqIDLcvWFJT4RQ4Bbvk=','jpegThumbnail':fs[_0xcdc6be(0xd1)](_0xcdc6be(0xcc))},'productId':_0xcdc6be(0xc9),'title':''+nama,'description':''+menunya,'productImageCount':0x1},'businessOwnerJid':''+ownerJid,'contextInfo':{'forwardingScore':0x270f,'isForwarded':!![]}}},{'quoted':ftrol,'contextInfo':{'mentionedJid':[dtod,otod,stod]}}),helga['relayWAMessage'](anu));
...
mhan = await helga.prepareMessage(from, pporigi, image, {thumbnail: pporigi})
const btnBngsat = {
imageMessage: mhan.message.imageMessage,
contentText: `${menunya}`,
footerText: `٬࿊⃟DZ-GANZシ`,
buttons: gbutsan,
headerType: 4
}
helga.sendMessage(from, btnBngsat, MessageType.buttonsMessage, { quoted: ftrol, caption: menunya, contextInfo: { mentionedJid: [dtod,otod,stod]}})
                  }
break
case 'store':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
       ...
       stst = await helga.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menu = `*🕊️ ִ ۫ ּ OPEN SEWA BOT BY DZ Ꮺ ָ࣪ ۰ 🕊️*
...
*🐢 › SC NO PASARAN › 🐢*`
sendButLocation(from, `${menu}`, "_DZ Ganz🌸_", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'𝙈𝙀𝙉𝙐🍁'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
⚠️ Segala kebijakan dan ketentuan Dzbot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan DzBotz-
😖🙏`
menu =`_DZganz💤_`
gbutsan = [
{buttonId:`store`,buttonText:{displayText:'YOI BANG'},type:1}
]
mhan = await helga.prepareMessage(from, logonya, image, {thumbnail: logonya})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
contentText: `${fill}`,
footerText: `${menu}`,
...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan DzBotz-
😖🙏`
sendButLocation(from, `${menu}`, "*_© RaaDz_", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
*࿊⃟🍁 Nama :* ${pushname}
*࿊⃟🍁 Nomor :* @${sender.split('@')[0]}
*࿊⃟🍁 Seri:* ${serialUser}
*࿊⃟🍁 Pengguna:* ${_registered.length}
*࿊⃟🍁 Jam :* ${jmn} 
*࿊⃟🍁 Hari :* ${week} ${weton}
*࿊⃟🍁 Tanggal :* ${calender}
...
await helga.sendMessage(from, btnskuy, MessageType.buttonsMessage, {quoted: ftrol})
		break
case 'donasi':
dona = fs.readFileSync('./media/donasi1.jpg')
doni =`*╭─❒ 『 Donasi』 ──────*
*│*
...
await helga.sendMessage(from, btnharam, MessageType.buttonsMessage, {quoted: ftrol})
                }
                break
                case 'antidelete':
      if (!isOwner && !mek.key.fromMe) return sticOwner(from)
...
Giliran = @${tty.player1.split('@')[0]}`
 helga.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     helga.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────『 *ALERT-ERROR*』─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer DZBott",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://wa.me/6282138919347"}}})
	}
    }
    }
    }
